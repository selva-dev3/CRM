  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      <PopoverTrigger
        ...
        className="p-2 rounded-xl transition cursor-pointer relative border flex items-center justify-center bg-slate-50 text-slate-700 hover:text-blue-600 hover:bg-slate-100 border-slate-200 shrink-0"
      >
      ...
      <PopoverContent
        ...
        className="p-0 w-[calc(100vw_-_2rem)] sm:w-[380px] rounded-2xl border-slate-200 bg-white shadow-xl overflow-hidden"
      >
        <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100">
          <div>
            <h3 id="notifications-panel-title" className="text-sm font-bold text-slate-900">
              Notifications
            </h3>
        ...
        <div className="max-h-[min(20rem,calc(100dvh_-_8rem))] overflow-y-auto divide-y divide-slate-100">
          {isLoading ? (
