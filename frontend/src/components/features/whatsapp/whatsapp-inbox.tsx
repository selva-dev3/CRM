...
import { useWhatsAppAssignees, useWhatsAppConversation, useWhatsAppConversationAction, useWhatsAppConversations, useWhatsAppIdentityAction, useWhatsAppMessages, useWhatsAppScope, useWhatsAppSend, useWhatsAppSendTemplate, useWhatsAppTemplates } from '@/lib/api/whatsapp';
...
export function WhatsAppInbox() {
  ...
  const list = useWhatsAppConversations(search, conversationOffset, canRead);
  const detail = useWhatsAppConversation(selected, canRead);
  const messages = useWhatsAppMessages(selected, messageOffset, canRead);
