...
export default function PaymentsPage() {
  ...
  return (
    <div className="w-full space-y-6 pb-12">
      <div><h1 className="flex items-center gap-2.5 text-2xl font-bold tracking-tight text-slate-900"><CreditCard className="h-7 w-7 text-indigo-600" /> Payments</h1><p className="mt-0.5 text-sm text-slate-500">Manual payments recorded for your organization.</p></div>
