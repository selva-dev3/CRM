...
api_router.include_router(
    super_admin.router,
    prefix="/super-admin",
    tags=["25. Super Admin Suite"],
    dependencies=[Depends(require_permission("super_admin:manage"))],
)
...
api_router.include_router(
    invitations.router, prefix="/organizations/invitations", tags=["4. Organizations & Invitations"]
)
...
api_router.include_router(
    dashboard.router,
    prefix="/dashboard",
    tags=["5. Dashboard & KPIs"],
    dependencies=[Depends(get_current_user)],
)
api_router.include_router(
    leads.router,
    prefix="/leads",
    tags=["6. Lead Management"],
    dependencies=[Depends(get_current_user)],
)
api_router.include_router(
    contacts.router,
    prefix="/contacts",
    tags=["7. Contact Management"],
    dependencies=[Depends(get_current_user)],
)
api_router.include_router(
    companies.router,
    prefix="/companies",
    tags=["8. Company Management"],
    dependencies=[Depends(get_current_user)],
)
api_router.include_router(
    deals.router,
    prefix="/deals",
    tags=["9. Deal Management & Pipeline"],
    dependencies=[Depends(get_current_user)],
)
api_router.include_router(
    tasks.router,
...
api_router.include_router(
    emails.router,
    prefix="/emails",
    tags=["14. Emails & Inbox"],
    dependencies=[Depends(get_current_user)],
)
api_router.include_router(
    notes.router, prefix="/notes", tags=["15. Notes"], dependencies=[Depends(get_current_user)]
)
api_router.include_router(
    documents.router,
    prefix="/documents",
    tags=["16. Document Storage"],
    dependencies=[Depends(get_current_user)],
)
api_router.include_router(
    products.router,
    prefix="/products",
    tags=["17. Product Catalog"],
    dependencies=[Depends(get_current_user)],
)
api_router.include_router(
    quotes.router,
...
api_router.include_router(
    reports.router,
    prefix="/reports",
    tags=["21. Reports & Analytics"],
    dependencies=[Depends(get_current_user)],
)
api_router.include_router(
    settings.router,
    prefix="/settings",
    tags=["22. Settings & Audit Logs"],
    dependencies=[Depends(get_current_user)],
)
api_router.include_router(
    integrations.router,
