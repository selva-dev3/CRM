...
async def list_custom_reports(
    ...
    return await report_service.list_custom_reports(db, current_user=current_user)
...
async def list_scheduled_reports(
    ...
    return await report_service.list_scheduled_reports(db, current_user=current_user)
