...
async def improve_email(
    email_text: str, tone: str = "Professional", db: AsyncSession = Depends(get_db)
):
...
async def sales_assistant_chat(
    message: str, conversation_id: str | None = None, db: AsyncSession = Depends(get_db)
):
...
async def enrich_company(
    company_name: str, domain: str | None = None, db: AsyncSession = Depends(get_db)
):
