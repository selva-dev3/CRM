...
QUOTE_TRANSITIONS: dict[str, set[str]] = {
    QUOTE_DRAFT: {QUOTE_DRAFT, QUOTE_PENDING_APPROVAL, QUOTE_APPROVED, QUOTE_REJECTED},
    QUOTE_PENDING_APPROVAL: {QUOTE_PENDING_APPROVAL, QUOTE_APPROVED, QUOTE_REJECTED},
