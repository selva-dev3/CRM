...
def sample_quote_pdf() -> bytes:
    return render_quote_pdf(
        organization={
            "name": "Document QA organization",
            "address": "Sample business address",
            "email": "billing@example.test",
        },
        customer={
            "company": "Document QA customer",
            "name": "Sample recipient",
            "email": "buyer@example.test",
        },
        quote={
            "quote_number": "QA-QUOTE",
            "currency": "INR",
            "expires_at": "Test validity date",
            "total_amount": Decimal("212.40"),
        },
        items=[
            {
                "product_name": "Service & support <annual>",
                "quantity": 2,
